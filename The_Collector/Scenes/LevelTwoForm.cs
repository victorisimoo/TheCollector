...
namespace The_Collector.Scenes {
    ...
    public partial class LevelTwoForm : Form {
        ...
        public LevelTwoForm(Player playerRecord, List<Question> questions) {
        ...
        private void LevelTwoForm_Load(object sender, EventArgs e) { }
        ...
        //Método para lanzar una pregunta random.
